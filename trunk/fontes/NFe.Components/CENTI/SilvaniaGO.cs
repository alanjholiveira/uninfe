...
{
    public class SilvaniaGO : EmiteNFSeBase
    {
        ...
        public string URLAPIBase
        {
            get
            {
                if (tpAmb.Equals(TipoAmbiente.taHomologacao))
                    return $@"https://api.centi.com.br/nfe/{servico}/homologacao{rps}/GO/silvania";
                else
                    return $@"https://api.centi.com.br/nfe/{servico}{rps}/go/silvania";
            }
        }
        ...
        public SilvaniaGO(TipoAmbiente tpAmb, string pastaRetorno, string usuario, string senha)
