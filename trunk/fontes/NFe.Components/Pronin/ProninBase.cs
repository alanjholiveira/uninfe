                ...
                if (proninService == null)
                {
                    if (tpAmb == TipoAmbiente.taHomologacao)
                        switch (CodigoMun)
                        {
					       ...
					       case 3501301: //Álvares Machado-SP
                            ...
                            case 4301057: //Arroio do Sal-RS
                                proninService = new ArroioDoSal.h.ProninH(tpAmb, PastaRetorno, UsuarioProxy, SenhaProxy, DomainProxy, Certificado);
                                break;
                            default:
                        ...
                        switch (CodigoMun)
                        {
                            ...
                            case 4313953://Pantano Grande - RS
                                proninService = new PantanoGrandeRS.p.ProninP(tpAmb, PastaRetorno, UsuarioProxy, SenhaProxy, DomainProxy, Certificado);
                                break;
