...
{
    public class PiraquaraPR : EmiteNFSeBase
    {
        #region Private Fields

        private readonly ElotechService Servico = new ElotechService("https://piraquara.oxy.elotech.com.br/iss-ws/nfse203.wsdl");
        ...
        public PiraquaraPR(TipoAmbiente tpAmb, string pastaRetorno, string usuarioProxy, string senhaProxy, string proxyDomain, X509Certificate certificado)
