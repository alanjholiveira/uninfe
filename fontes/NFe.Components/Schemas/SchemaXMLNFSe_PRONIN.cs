...
namespace NFSe.Components
{
    public class SchemaXMLNFSe_PRONIN
    {
        public static void CriarListaIDXML()
        {
            ...
            #region XML de lote RPS - Pântano Grande-RS

            SchemaXML.InfSchemas.Add("NFSE-PRONIN-4313953-EnviarLoteRpsEnvio", new InfSchema()
            {
                Tag = "EnviarLoteRpsEnvio",
                ID = SchemaXML.InfSchemas.Count + 1,
                ArquivoXSD = "NFSe\\PRONIN\\nfse.xsd",
            ...
            #endregion XML de lote RPS - Pântano Grande-RS
            ...
            #endregion XML de lote RPS - São Pedro - SP

            #region XML de lote RPS - Castanhal - PA

            SchemaXML.InfSchemas.Add("NFSE-PRONIN-1502400-EnviarLoteRpsEnvio", new InfSchema()
            {
                Tag = "EnviarLoteRpsEnvio",
                ID = SchemaXML.InfSchemas.Count + 1,
                ArquivoXSD = "NFSe\\PRONIN\\nfse.xsd",
            ...
            #endregion XML de lote RPS - Castanhal - PA

            #region XML de lote RPS - São Sebastião da Grama - SP

            SchemaXML.InfSchemas.Add("NFSE-PRONIN-3550803-EnviarLoteRpsEnvio", new InfSchema()
            {
                Tag = "EnviarLoteRpsEnvio",
                ID = SchemaXML.InfSchemas.Count + 1,
                ArquivoXSD = "NFSe\\PRONIN\\nfse.xsd",
            ...
            #endregion XML de lote RPS - São Sebastião da Grama - SP

            #region XML de lote RPS - Arroio do Sal - RS

            SchemaXML.InfSchemas.Add("NFSE-PRONIN-4301057-EnviarLoteRpsEnvio", new InfSchema()
            {
                Tag = "EnviarLoteRpsEnvio",
                ID = SchemaXML.InfSchemas.Count + 1,
                ArquivoXSD = "NFSe\\PRONIN\\nfse.xsd",
            ...
            #endregion XML de lote RPS - Arroio do Sal - RS
        }
    }
}