    ...
    public class TaskNFSeRecepcionarLoteRps: TaskAbst
    {
        ...
        public override void Execute()
        {
            ...
            try
            {
                ...
                {
                    case 4105508:
                        ExecuteDLL(emp, oDadosEnvLoteRps.cMunicipio);
                        break;
                        ...
                        switch(padraoNFSe)
                        {
                            ...
                            case PadroesNFSe.BETHA:
                                ...
                                if(versao.Equals("2.02"))
                                {
                                    ...
                                    signbetha.Assinar(NomeArquivoXML, emp, oDadosEnvLoteRps.cMunicipio);
        ...
        private void ExecuteDLL(int emp, int municipio)
        {
            ...
            XmlRetorno(finalArqEnvio + ".xml", finalArqRetorno + ".xml");
