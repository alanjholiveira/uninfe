...
namespace NFSe.Components
{
    public class SchemaXMLNFSe_ABACO
    {
        public static void CriarListaIDXML()
        {
            ...
            #region XML de Consulta de Lote RPS
            SchemaXML.InfSchemas.Add("NFSE-ABACO_204-3144805-ConsultarLoteRpsEnvio", new InfSchema()
            {
                Tag = "ConsultarLoteRpsEnvio",
                ID = SchemaXML.InfSchemas.Count + 1,
                ArquivoXSD = "NFSe\\ABACO\\V2\\nfse_v2010.xsd",
            ...
            #region XML de lote RPS
            SchemaXML.InfSchemas.Add("NFSE-ABACO_204-3144805-EnviarLoteRpsEnvio", new InfSchema()
            {
                Tag = "EnviarLoteRpsEnvio",
                ID = SchemaXML.InfSchemas.Count + 1,
                ArquivoXSD = "NFSe\\ABACO\\V2\\nfse_v2010.xsd",
            ...
            #region Consulta NFSe por Rps
            SchemaXML.InfSchemas.Add("NFSE-ABACO_204-3144805-ConsultarNfseRpsEnvio", new InfSchema()
            {
                Tag = "ConsultarNfseRpsEnvio",
                ID = SchemaXML.InfSchemas.Count + 1,
                ArquivoXSD = "NFSe\\ABACO\\V2\\nfse_v2010.xsd",
            ...
            #region Consulta NFSe por período
            SchemaXML.InfSchemas.Add("NFSE-ABACO_204-3144805-ConsultarNfsEnvio", new InfSchema()
            {
                Tag = "ConsultarNfsEnvio",
                ID = SchemaXML.InfSchemas.Count + 1,
                ArquivoXSD = "NFSe\\ABACO\\V2\\nfse_v2010.xsd",
            ...
            SchemaXML.InfSchemas.Add("NFSE-ABACO_204-3144805-EnviarLoteRpsSincronoEnvio", new InfSchema()
            {
            ...
            SchemaXML.InfSchemas.Add("NFSE-ABACO_204-3144805-GerarNfseEnvio", new InfSchema()
            {
                Tag = "GerarNfseEnvio",
                ID = SchemaXML.InfSchemas.Count + 1,
                ArquivoXSD = "NFSe\\ABACO\\V2\\nfse_v2010.xsd",
