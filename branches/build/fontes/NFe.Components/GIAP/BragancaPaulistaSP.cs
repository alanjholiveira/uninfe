...
{
    public class BragancaPaulistaSP : EmiteNFSeBase
    {
        ...
        public string URLAPIBase
        {
            get
            {
                if (tpAmb.Equals(TipoAmbiente.taHomologacao))
                    return $@"http://webservice.giap.com.br/WSNfsesPmbp/nfseresources/ws/{versao}{servico}/simula";
                else
                    return $@"http://webservice.giap.com.br/WSNfsesPmbp/nfseresources/ws/{versao}{servico}";                        
            }
        }
        ...
        public BragancaPaulistaSP(TipoAmbiente tpAmb, string pastaRetorno, string senha)
