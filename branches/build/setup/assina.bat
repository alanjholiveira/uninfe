...
:setup
   "C:\Program Files (x86)\Microsoft SDKs\ClickOnce\SignTool\signtool.exe" sign /a /t http://timestamp.verisign.com/scripts/timstamp.dll \projetos\instaladores\iuninfe5.exe \projetos\instaladores\iuninfe5_fw35.exe \projetos\instaladores\iuninfe5_fw46_x86.exe \projetos\instaladores\iuninfe5_fw46_x64.exe
   Goto Fim
